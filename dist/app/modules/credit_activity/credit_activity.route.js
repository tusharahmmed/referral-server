...
exports.CreditActivityRoutes = void 0;
const express_1 = require("express");
const user_1 = require("../../../enums/user");
const auth_1 = __importDefault(require("../../middlewares/auth"));
const credit_activity_controller_1 = require("./credit_activity.controller");
 ...
 *                         example: 2025-10-24T13:37:47.023Z
 */
router.get('/profile-activities', (0, auth_1.default)(user_1.USER_ROLE.SUPER_ADMIN, user_1.USER_ROLE.USER), credit_activity_controller_1.CreditActivityController.getActivitiesByUserId);
exports.CreditActivityRoutes = router;
